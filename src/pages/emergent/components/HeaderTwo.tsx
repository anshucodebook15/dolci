...
const HeaderTwo = () => {
    ...
    return (
        <header
            className={`fixed top-0 left-0 right-0 z-50 transition duration-300 bg-white shadow-lg  `}
        >
                        ...
                        {navigationItems.map((item) =>
                            item.href.startsWith("/#") ? (
                                <button
                                    ...
                                    className={`font-montserrat font-medium transition-colors duration-300 text-gray-700 hover:text-midnight-blue`}
                                >
                                    {item.name}
                                </button>
                            ) : (
