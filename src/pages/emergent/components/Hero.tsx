  ...
  return (
    ...
    <div className="">
      ...
      <section
        ...
        className="max-w-[1800px] mx-auto relative min-h-[50rem] sm:min-h-[50rem] md:min-h-[50rem] lg:min-h-[50rem] xl:min-h-[55rem] flex items-end justify-center overflow-hidden md:pb-30 pb-20"
      >
        {/* Background Video */}
        ...
        <div className="absolute transform inset-0 w-full h-full overflow-hidden z-0 mt-[-40px] sm:mt-[-20px]  md:mt-[20px] lg:mt-[-60px] xl:mt-[-120px]">
          <video
